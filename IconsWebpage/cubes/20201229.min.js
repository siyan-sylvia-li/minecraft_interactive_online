...
pbjsChunk([238],{452:function(e,r,t){e.exports=t(453)},453:function(e,r,t){"use strict";Object.defineProperty(r,"__esModule",{value:!0}),t.d(r,"spec",function(){return m}),r.resetUserSync=function(){s=!1},r.getSyncUrl=function(){return o};var I=t(0),n=t(1),d=t(11),j=t(2),R=t(3);function T(e){return(T="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}function O(e,r){return function(e){if(Array.isArray(e))return e}(e)||function(e,r){if("undefined"==typeof Symbol||!(Symbol.iterator in Object(e)))return;var t=[],n=!0,i=!1,o=void 0;try{for(var d,s=e[Symbol.iterator]();!(n=(d=s.next()).done)&&(t.push(d.value),!r||t.length!==r);n=!0);}catch(e){i=!0,o=e}finally{try{n||null==s.return||s.return()}finally{if(i)throw o}}return t}(e,r)||function(e,r){if(!e)return;if("string"==typeof e)return i(e,r);var t=Object.prototype.toString.call(e).slice(8,-1);"Object"===t&&e.constructor&&(t=e.constructor.name);if("Map"===t||"Set"===t)return Array.from(e);if("Arguments"===t||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return i(e,r)}(e,r)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}()}function i(e,r){(null==r||r>e.length)&&(r=e.length);for(var t=0,n=new Array(r);t<r;t++)n[t]=e[t];return n}function _(){return(_=Object.assign||function(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])}return e}).apply(this,arguments)}var o="https://x.bidswitch.net/sync?ssp=themediagrid",s=!1,a="Bid from response has no auid parameter - ",u="Bid from response has no adm parameter - ",c="Array of bid objects is empty",p="Seatbid array from response has empty item",l="Response is empty",f="Response has empty seatbid array",y="Seatbid from response has no array of bid objects - ",m={code:"grid",supportedMediaTypes:[j.b,j.d],isBidRequestValid:function(e){return!!e.params.uid},buildRequests:function(e,r){if(!e.length)return null;var f=null,y=null,m=null,g=null,b=null,t=null,n=null,i=r||{},v=i.bidderRequestId,h=i.auctionId,o=i.gdprConsent,d=i.uspConsent,s=i.timeout,a=i.refererInfo,u=a?encodeURIComponent(a.referer):"",S=[],w={};e.forEach(function(e){v=v||e.bidderRequestId,h=h||e.auctionId,g=g||e.schain,b=b||e.userId;var r=e.params,t=r.uid,n=r.keywords,i=r.bidFloor,o=e.mediaTypes,d=e.bidId,s=e.adUnitCode,a=e.rtd;w[d]=e,f||I.isEmpty(n)||(f=I.transformBidderParamKeywords(n));var u=a&&a.jwplayer&&a.jwplayer.targeting;u&&(!y&&u.segments&&(y=u.segments),!m&&u.content&&(m=u.content));var c,p,l={id:d,tagid:t.toString(),ext:{divid:s},bidfloor:function(e,r,t){var n=e.video?"video":"banner",i=r||0;{var o;"function"==typeof t.getFloor&&("object"!==T(o=t.getFloor({currency:"USD",mediaType:n,size:t.sizes.map(function(e){var r=O(e,2);return{w:r[0],h:r[1]}})}))||"USD"!==o.currency||isNaN(parseFloat(o.floor))||(i=Math.max(i,parseFloat(o.floor))))}return i}(o||{},i,e)};o&&!o[j.b]||(c=function(e,r){var t=r.sizes||e.sizes;if(!t||!t.length)return;var n=t.map(function(e){return I.parseGPTSingleSizeArrayToRtbSize(e)}),i=I.parseGPTSingleSizeArrayToRtbSize(t[0]);n.length&&(i.format=n);return i}(e,o?o[j.b]:{}))&&(l.banner=c),o&&o[j.d]&&((p=function(e,r){var t=r.playerSize,n=r.mimes,i=r.durationRangeSec,o=(t||e.sizes||[])[0];if(!o)return;var d=I.parseGPTSingleSizeArrayToRtbSize(o);n&&(d.mimes=n);i&&2===i.length&&(d.minduration=i[0],d.maxduration=i[1]);return d}(e,o[j.d]))&&(l.video=p)),(l.banner||l.video)&&S.push(l)});var c={tid:h,ext:{wrapper:"Prebid_js",wrapper_version:"4.17.0"}};g&&(c.ext.schain=g);var p=R.b.getConfig("bidderTimeout")||s,l=s?Math.min(p,s):p,x={id:v,site:{page:u},tmax:l,source:c,imp:S};m&&(x.site.content=m),y&&y.length&&(t={data:[{name:"iow_labs_pub_data",segment:y.map(function(e){return{name:"jwpseg",value:e}})}]}),o&&o.consentString&&(n={consent:o.consentString}),b&&(b.tdid&&((n=n||{}).eids=n.eids||[],n.eids.push({source:"adserver.org",uids:[{id:b.tdid,ext:{rtiPartner:"TDID"}}]})),b.id5id&&b.id5id.uid&&((n=n||{}).eids=n.eids||[],n.eids.push({source:"id5-sync.com",uids:[{id:b.id5id.uid}],ext:b.id5id.ext})),b.lipb&&b.lipb.lipbid&&((n=n||{}).eids=n.eids||[],n.eids.push({source:"liveintent.com",uids:[{id:b.lipb.lipbid}]})),b.idl_env&&((n=n||{}).eids=n.eids||[],n.eids.push({source:"identityLink",uids:[{id:b.idl_env}]})),b.criteoId&&((n=n||{}).eids=n.eids||[],n.eids.push({source:"criteo.com",uids:[{id:b.criteoId}]})),b.digitrustid&&b.digitrustid.data&&b.digitrustid.data.id&&((n=n||{}).digitrust=_({},b.digitrustid.data))),n&&Object.keys(n).length&&((t=t||{}).ext=n),t&&(x.user=t);var A=I.transformBidderParamKeywords({user:I.deepAccess(R.b.getConfig("fpd.user"),"keywords")||null,context:I.deepAccess(R.b.getConfig("fpd.context"),"keywords")||null});return A.length&&(f=(f||[]).concat(A)),f&&0<f.length&&f.forEach(z),f&&(x.ext={keywords:f}),o&&o.gdprApplies&&(x.regs={ext:{gdpr:o.gdprApplies?1:0}}),d&&(x.regs||(x.regs={ext:{}}),x.regs.ext.us_privacy=d),{method:"POST",url:"https://grid.bidswitch.net/hbjson",data:JSON.stringify(x),newFormat:!0,bidsMap:w}},interpretResponse:function(e,r){e=e&&e.body;var t,n=[];return e?e.seatbid&&!e.seatbid.length&&(t=f):t=l,!t&&e.seatbid&&e.seatbid.forEach(function(e){!function(e,r,t){if(!e)return;var n;e.auid||(n=a+JSON.stringify(e));{var i,o;e.adm?(i=r.bidsMap[e.impid])&&(o={requestId:i.bidId,bidderCode:m.code,cpm:e.price,width:e.w,height:e.h,creativeId:e.auid,currency:"USD",netRevenue:!1,ttl:360,dealId:e.dealid},"video"===e.content_type?(o.vastXml=e.adm,o.mediaType=j.d,o.adResponse={content:o.vastXml},i.renderer||i.mediaTypes&&i.mediaTypes.video&&"outstream"!==i.mediaTypes.video.context||(o.renderer=function(e){var r=d.a.install({id:e.id,url:e.url,loaded:!1});try{r.setRender(g)}catch(e){I.logWarn("Prebid Error calling setRender on renderer",e)}return r}({id:i.bidId,url:"https://acdn.adnxs.com/video/outstream/ANOutstreamVideo.js"}))):(o.ad=e.adm,o.mediaType=j.b),t.push(o)):n=u+JSON.stringify(e)}n&&I.logError(n)}(function(e){e?e.bid?e.bid[0]||I.logError(c):I.logError(y+JSON.stringify(e)):I.logError(p);return e&&e.bid&&e.bid[0]}(e),r,n)}),t&&I.logError(t),n},getUserSyncs:function(e,r,t,n){if(!s&&e.pixelEnabled){var i="";return t&&"string"==typeof t.consentString&&("boolean"==typeof t.gdprApplies?i+="&gdpr=".concat(Number(t.gdprApplies),"&gdpr_consent=").concat(t.consentString):i+="&gdpr_consent=".concat(t.consentString)),n&&(i+="&us_privacy=".concat(n)),s=!0,{type:"image",url:o+i}}}};function z(e){var r;r=e.value,I.isArray(r)&&0<r.length&&""===e.value[0]&&delete e.value}function g(e){e.renderer.push(function(){window.ANOutstreamVideo.renderAd({targetId:e.adUnitCode,adResponse:e.adResponse})})}Object(n.registerBidder)(m)}},[452]);
...
pbjsChunk([214],{511:function(t,n,r){t.exports=r(512)},512:function(t,n,r){"use strict";Object.defineProperty(n,"__esModule",{value:!0}),r.d(n,"jwplayerSubmodule",function(){return p}),n.fetchTargetingInformation=y,n.fetchTargetingForMediaId=j,n.enrichAdUnits=w,n.extractPublisherParams=D,n.getVatFromCache=O,n.getVatFromPlayer=I,n.formatTargetingResponse=T,n.addTargetingToBid=E;var e=r(13),a=r(3),i=r(4),o=r(0),c=r(10),u=r.n(c),f=r(19);function l(){return(l=Object.assign||function(t){for(var n=1;n<arguments.length;n++){var r=arguments[n];for(var e in r)Object.prototype.hasOwnProperty.call(r,e)&&(t[e]=r[e])}return t}).apply(this,arguments)}var s,d="jwplayer",g={},v={},m=0,p={name:d,getBidRequestData:function(t,n){m=0,w(t.adUnits||Object(f.a)().adUnits),m<=0?n():s=n},init:function(t,n){return!0}};function y(t){var n=t.mediaIDs;n&&n.forEach(function(t){j(t)})}function j(r){var t=Object(i.b)();v[r]=null,t("https://cdn.jwplayer.com/v2/media/".concat(r),{success:function(t){var n=function(t){var n;try{var r=JSON.parse(t);if(!r)throw"Empty response";var e=r.playlist;if(!e||!e.length)throw"Empty playlist";n=e[0].jwpseg}catch(t){Object(o.logError)(t)}return n}(t);h(n,r),b(r,!!n)},error:function(){Object(o.logError)("failed to retrieve targeting information"),b(r,!1)}})}function h(t,n){t&&n&&(g[n]=t)}function b(t,n){var r=v[t];r&&(r(n?O(t):{mediaID:t}),m--),delete v[t],0<m||s&&(s(),s=null)}function w(t){var n=a.b.getConfig("fpd.context.data.jwTargeting");t.forEach(function(r){!function(t,n){if(!t||!Object.keys(t).length)return;var r=t.playerID,e=t.mediaID;if(void 0!==v[e])return function(t,n,r){var e=I(t,n);e?r(e):(m++,v[n]=r)}(r,e,n);var a=O(e)||I(r,e)||{mediaID:e};n(a)}(D(r,n),function(t){var n;t&&(n=T(t),function(t,n){if(!t||!n)return;t.forEach(function(t){return E(t,n)})}(r.bids,n))})})}function D(t,n){var r;try{r=t.fpd.context.data.jwTargeting}catch(t){}return l({},n,r)}function O(t){var n=g[t];return n?{segments:n,mediaID:t}:null}function I(t,n){var r=function(t){var n=window.jwplayer;if(!n)return void Object(o.logError)("jwplayer.js was not found on page");var r=n(t);return r&&r.getPlaylist?r:void Object(o.logError)("player ID did not match any players")}(t);if(!r)return null;var e=n?u()(r.getPlaylist(),function(t){return t.mediaid===n}):r.getPlaylistItem();if(!e)return null;n=n||e.mediaid;var a=e.jwpseg;return h(a,n),{segments:a,mediaID:n}}function T(t){var n,r=t.segments,e=t.mediaID,a={};return r&&r.length&&(a.segments=r),e&&(n="jw_"+e,a.content={id:n}),a}function E(t,n){var r=t.rtd||{},e={};e[d]=l({},r[d],{targeting:n}),t.rtd=l({},r,e)}a.b.getConfig("realTimeData",function(t){var n=t.realTimeData.dataProviders,r=n&&u()(n,function(t){return t.name&&t.name.toLowerCase()===d}),e=r&&r.params;e&&y(e)}),Object(e.e)("realTimeData",p)}},[511]);
